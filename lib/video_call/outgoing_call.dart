...
class OutgoingCall extends StatefulWidget {
  ...
  const OutgoingCall(this.data, {Key? key}) : super(key: key);

  @override
  OutgoingCallState createState() => OutgoingCallState();
}

class OutgoingCallState extends State<OutgoingCall> {
  ...
  callEnd() async {
    FormData body = FormData.fromMap({
     ...
     await STM().postWithoutDialog(context, 'customer/reject_call', body);
  }
}
